  ...
  return(
    <dialog
      ...
      className="fixed top-1/3 left-1/2 -translate-x-1/2 w-90 h-fit justify-center items-center
        bg-[var(--color-bg-secondary)] border-1 rounded-md opacity-95 pb-8">
      <div className="flex flex-col">
        <h1 className="w-full text-[var(--color-text-secondary)] font-variation-settings-wght-700 m-10 mb-4">Which game would you like to play?</h1>
